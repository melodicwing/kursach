		...
		<div class='col-xs-12 col-sm-4 col-sm-push-8'>
			<form>
				...
				<div class='form-group'>
					...
					<div class='row'>
						<div class='col-xs-6'>
							<label for='input__from_h'>{{ trans('user/table.from_h') }}</label>
						...
						<div class='col-xs-6'>
							<label for='input__from_m'>{{ trans('user/table.from_m') }}</label>
				...
				<div class='form-group'>
					...
					<div class='row'>
						<div class='col-xs-6'>
							<label for='input__to_h'>{{ trans('user/table.to_h') }}</label>
						...
						<div class='col-xs-6'>
							<label for='input__to_m'>{{ trans('user/table.to_m') }}</label>
